...
class GeneratorTest extends BaseTestCase
{
    ...
    public function testWsdlOptions(): void
    {
        ...
        $wsdlOptions->setWsdl('G:\WEBs\MyLibraries\easywsdl2php\tests\Fixtures\test.xml');
    ...
    public function testWithNamespaceAndClassName(): void
    {
        ...
        $wsdlOptions2->setWsdl('G:\WEBs\MyLibraries\easywsdl2php\tests\Fixtures\testReplacedProperties.xml');
